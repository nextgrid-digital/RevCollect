...
const plans = [
  {
    ...
    description: 'For waitlist firms invited to the private beta.',
    features: [
      'Collections inbox with AI draft review',
      'Aging report and customer breakdown',
  ...
  },
  {
    name: 'Growth',
    price: 'Coming soon',
    description: 'For firms scaling collections across many client books.',
    features: [
