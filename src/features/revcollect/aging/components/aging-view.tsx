...
const agingReportMaxWidth = 'mx-auto w-full max-w-6xl';
...
export function AgingView() {
  ...
  const showSkeleton = !isHydrated || isPending || !data;
  ...
  return (
    <WorkspaceCanvas className='flex-col'>
      <WorkspacePageTitle title='Aging' className='h-8 shrink-0' />
      <div className='scroll-stable min-h-0 flex-1 overflow-y-auto'>
        <div className={cn(agingReportMaxWidth, 'space-y-4 px-4 pb-4')}>
